...
export default function AddProduct() {
  ...
  const isLaptopCategory =
    selectedCategory === "New Laptop" || selectedCategory === "Used Laptop";
  ...
  useEffect(() => {
    if (!selectedCategory || isLaptopCategory) return;
    setValue("ram", "");
    setValue("disk", "");
    setValue("storage", "");
    setValue("type", "");
    replace([]);
  }, [isLaptopCategory, replace, selectedCategory, setValue]);
            ...
            >
              ...
              {!selectedCategory ? (
                <p className="rounded-xl border border-dashed border-slate-200 bg-slate-50 px-4 py-3 text-sm text-slate-600">
                  Select a category to load the product form fields.
                </p>
              ) : (
                <>
                  <div className="grid md:grid-cols-2 gap-4">
                    ...
                    <div className="rounded-xl border border-gray-200 bg-gray-50/50 p-4 space-y-4">
                      <div className="flex flex-col gap-2 sm:flex-row sm:items-start sm:justify-between">
                        <div>
                          ...
                          <p className="text-xs text-gray-500 mt-0.5 max-w-xl"></p>
                        </div>
